...
public class ListaDoblementeEnlazada<T> implements Serializable {
	...
	public void agregarAlInicio(T dato) {
		...
		if (estaVacia()) {
			...
			// Si la lista no está vacía, el nuevo nodo se convierte en la nueva cabeza y la
			// referencia
	...
	public void agregarAlFinal(T dato) {
		...
		if (estaVacia()) {
			...
			// Si la lista no está vacía, el nuevo nodo se convierte en la nueva cola y la
			// referencia
